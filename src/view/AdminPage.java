...
import table.model.ZaposleniTableModel;
...
public final class AdminPage extends JFrame {
    ...
    // Deklarisanje osnovnih parametara za dalji rad
    ...
    public void adminPage() {
        ...
        jLabelArr = new JLabel[4];
        icon = new ImageIcon("images/zaposleni.png");
            jLabelArr[0] = new JLabel("Zaposleni", icon, JLabel.CENTER); 
            icon = new ImageIcon("images/knjige.png");
            jLabelArr[1] = new JLabel("Knjige", icon, JLabel.CENTER);
            icon = new ImageIcon("images/korisnici.png");
            jLabelArr[2] = new JLabel("Korisnici", icon, JLabel.CENTER);
            icon = new ImageIcon("images/izvestaj.png");
            jLabelArr[3] = new JLabel("Izveštaj", icon, JLabel.CENTER);
            
        for (int i = 0; i < 4; i++) {
            jLabelArr[i].setFont(new Font("TimesRoman", Font.PLAIN, 14));
            ...
            jLabelArr[i].addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    if (e.getSource() == jLabelArr[0]) {
                        tabela.setModel(new ZaposleniTableModel(zaposleniKontroler));
                        tabela.updateUI();
                        tabelaZaposleni(e);
                        jLabelArr[0].setBackground(glavnaBojaTamnije);
        ...
        tabela = new JTable(new ZaposleniTableModel(zaposleniKontroler));
        ...
        dodajZaposlenogLabel = new JLabel(icon);
        dodajKnjiguLabel = new JLabel(icon);
        dodajKorisnikaLabel = new JLabel(icon);
        dodajZaposlenogLabel.addMouseListener(new MouseAdapter() {
            @Override
            ...
            @Override
            public void mouseEntered(MouseEvent evt) {
                dodajZaposlenogLabel.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
            }
        });
        ...
        meniPodkategorijePanel.add(dodajZaposlenogLabel);
        
        icon = new ImageIcon("images/edit_30px.png");
        izmeniZaposlenogLabel = new JLabel(icon);
        izmeniKnjiguLabel = new JLabel(icon);
        izmeniKorisnikaLabel = new JLabel(icon);
        izmeniZaposlenogLabel.addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent evt) {
        ...
        meniPodkategorijePanel.add(izmeniZaposlenogLabel);
        
        
        icon = new ImageIcon("images/delete_sign_30px.png");
        obrisiZaposlenogLabel = new JLabel(icon);
        obrisiKnjiguLabel = new JLabel(icon);
        obrisiKorisnikaLabel = new JLabel(icon);
        obrisiZaposlenogLabel.addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent evt) {
            if (tabela.getSelectedRow() < 0) {
                ...
                zaposleniKontroler.obrisiZaposlenog(i);
        ...
        meniPodkategorijePanel.add(obrisiZaposlenogLabel);
    ...
    public void dodajZaposlenog() {
        JFrame dodajZaposlenogFrame = new JFrame("Dodaj Zaposlenog");
        JPanel dodajZaposlenogPanel = new JPanel(new GridBagLayout());
        GridBagConstraints gbc = new GridBagConstraints();
        JLabel ime = new JLabel("Ime zaposlenog:");
        imeTextField= new JTextField(15);
        JLabel prezime = new JLabel("Prezime zaposlenog:");
        ...
        JLabel datumZaposlenja = new JLabel("Datum zaposlenja:");
        datum = new JDateChooser();
        JLabel pozicija = new JLabel("Pozicija:");
        String [] pozicije= {"Odaberi", "Admin", "Radnik"};
        pozicijeComboBox = new JComboBox(pozicije);
        pozicijeComboBox.setSelectedIndex(0);
        JLabel plata = new JLabel("Plata:");
        plataTextField= new JTextField(15);
        ...
        dodajZaposlenogBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dodajZaposlenogActionPerformed(evt);
                dodajZaposlenogFrame.dispose();
                //TableModel a = new ZaposleniTableModel(zaposleniKontroler);
                tabela.getModel();
                tabela.updateUI();
            }
        });
        ...
        gbc.fill = GridBagConstraints.BOTH;
        gbc.insets = new Insets(10, 10, 10, 10);
        dodajZaposlenogPanel.add(ime, gbc);
        dodajZaposlenogPanel.add(prezime, gbc);
        dodajZaposlenogPanel.add(adresa, gbc);
        dodajZaposlenogPanel.add(grad, gbc);
        dodajZaposlenogPanel.add(JMBG, gbc);
        dodajZaposlenogPanel.add(brTelefona, gbc);
        dodajZaposlenogPanel.add(email, gbc);
        gbc.gridx = 2;
        dodajZaposlenogPanel.add(datumZaposlenja, gbc);
        dodajZaposlenogPanel.add(pozicija, gbc);
        dodajZaposlenogPanel.add(plata, gbc);
        dodajZaposlenogPanel.add(username, gbc);
        dodajZaposlenogPanel.add(password, gbc);
        gbc.gridx = 1;
        dodajZaposlenogPanel.add(imeTextField, gbc);
        dodajZaposlenogPanel.add(prezimeTextField, gbc);
        dodajZaposlenogPanel.add(adresaTextField, gbc);
        dodajZaposlenogPanel.add(gradTextField, gbc);
        dodajZaposlenogPanel.add(JMBGTextField, gbc);
        dodajZaposlenogPanel.add(brTelefonaTextField, gbc);
        dodajZaposlenogPanel.add(emailTextField, gbc);
        gbc.gridx = 3;
        dodajZaposlenogPanel.add(datum, gbc);
        dodajZaposlenogPanel.add(pozicijeComboBox, gbc);
        dodajZaposlenogPanel.add(plataTextField, gbc);
        dodajZaposlenogPanel.add(usernameTextField, gbc);
        dodajZaposlenogPanel.add(passwordTextField, gbc);
        gbc.gridx = 3;
        gbc.gridy = 5;
        gbc.gridheight = 12;
        dodajZaposlenogPanel.add(dodajZaposlenogBtn, gbc);

        dodajZaposlenogFrame.getContentPane().add(dodajZaposlenogPanel);
        dodajZaposlenogFrame.pack();
        dodajZaposlenogFrame.setLocationRelativeTo(null);
        dodajZaposlenogFrame.setResizable(false);
        dodajZaposlenogFrame.setVisible(true);
    }
    
    public void izmeniZaposlenog() {
        JFrame izmeniZaposlenogFrame = new JFrame("Izmeni Zaposlenog");
        JPanel izmeniZaposlenogPanel = new JPanel(new GridBagLayout());
        GridBagConstraints gbc = new GridBagConstraints();
        JLabel ime = new JLabel("Ime zaposlenog:");
        imeTextField= new JTextField(15);
        JLabel prezime = new JLabel("Prezime zaposlenog:");
        ...
        izmeniZaposlenogBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                izmeniZaposlenog(evt);
                izmeniZaposlenogFrame.dispose();
                tabela.setModel(new ZaposleniTableModel(zaposleniKontroler));
                tabela.updateUI();
        ...
        gbc.fill = GridBagConstraints.BOTH;
        gbc.insets = new Insets(10, 10, 10, 10);
        izmeniZaposlenogPanel.add(ime, gbc);
        izmeniZaposlenogPanel.add(prezime, gbc);
        izmeniZaposlenogPanel.add(adresa, gbc);
        izmeniZaposlenogPanel.add(grad, gbc);
        izmeniZaposlenogPanel.add(JMBG, gbc);
        gbc.gridx = 2;
        izmeniZaposlenogPanel.add(brTelefona, gbc);
        izmeniZaposlenogPanel.add(email, gbc);
        izmeniZaposlenogPanel.add(pozicija, gbc);
        izmeniZaposlenogPanel.add(plata, gbc);
        gbc.gridx = 1;
        izmeniZaposlenogPanel.add(imeTextField, gbc);
        izmeniZaposlenogPanel.add(prezimeTextField, gbc);
        izmeniZaposlenogPanel.add(adresaTextField, gbc);
        izmeniZaposlenogPanel.add(gradTextField, gbc);
        izmeniZaposlenogPanel.add(JMBGTextField, gbc);
        gbc.gridx = 3;
        izmeniZaposlenogPanel.add(brTelefonaTextField, gbc);
        izmeniZaposlenogPanel.add(emailTextField, gbc);
        izmeniZaposlenogPanel.add(pozicijeComboBox, gbc);
        izmeniZaposlenogPanel.add(plataTextField, gbc);
        gbc.gridx = 1;
        gbc.gridwidth = 2;
        gbc.gridy = 5;
        gbc.gridheight = 12;
        izmeniZaposlenogPanel.add(izmeniZaposlenogBtn, gbc);
        
        izmeniZaposlenogFrame.getContentPane().add(izmeniZaposlenogPanel);
        izmeniZaposlenogFrame.pack();
        izmeniZaposlenogFrame.setLocationRelativeTo(null);
        izmeniZaposlenogFrame.setResizable(false);
        izmeniZaposlenogFrame.setVisible(true);
    }
    ...
    private void dodajZaposlenogActionPerformed(ActionEvent evt) {                                                 
        java.awt.EventQueue.invokeLater(() -> {
            ...
            String pozicija = pozicijeComboBox.getSelectedItem().toString();
            Integer plata = Integer.valueOf(plataTextField.getText());
            String username = usernameTextField.getText();
            String password = passwordTextField.getText();
            
            if (zaposleniKontroler.dodajZaposlenog(JMBG, ime, prezime, adresa, grad, 
                    brTelefona, email, null, pozicija, plata, username, password) == true) {
                ...
                pozicijeComboBox.setSelectedIndex(0);
                plataTextField.setText(null);
                usernameTextField.setText(null);
                passwordTextField.setText(null);
            }
        });
    }
    private void izmeniZaposlenog(ActionEvent evt) {
        
        int i = Integer.valueOf(tabela.getValueAt(tabela.getSelectedRow(),
                tabela.convertColumnIndexToModel(0)).toString()); 
        String JMBG = JMBGTextField.getText();
        String ime = imeTextField.getText();
        String prezime = prezimeTextField.getText();
        String adresa = adresaTextField.getText();
        ...
        String email = emailTextField.getText();
        String pozicija = pozicijeComboBox.getSelectedItem().toString();
        int plata = Integer.valueOf(plataTextField.getText());
        if (zaposleniKontroler.izmeniZaposlenog(i, JMBG, ime, prezime, adresa, grad, 
                brTelefona, email, pozicija, plata) == true) {
            JOptionPane.showMessageDialog(rootPane, "Uspešno su izmenjeni podaci o zaposlenom", 
                    "Uspešno", JOptionPane.INFORMATION_MESSAGE);
            tabela.updateUI();
        }
    }  
    ...
    private void postaviPoljaZaposleni(MouseEvent evt) {
            ...
            pozicijeComboBox.setSelectedItem(model.getValueAt(i, 9));
            plataTextField.setText(model.getValueAt(i, 10).toString());
    }
    ...
    private void tabelaZaposleni(MouseEvent evt) {
        try {
